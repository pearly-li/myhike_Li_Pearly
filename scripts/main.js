...
// The following is not included in Week 10's demo but our week 11 demo assumes we have this. Not sure if this is what I am supposed to have.
  ...
  currentUser.get().then((userDoc) => {
    ...
    if (bookmarks.includes(hikeDocID)) {
      currentUser
        ...
        // We add this here because it's synchronized with our databse
        .then(function () {
          let iconID = "save-" + hikeDocID;
          document.getElementById(iconID).innerText = "bookmarker_border";
        });
    } else {
      currentUser
        .update({
